...
test('Correct Rower behaviour for three noisefree strokes with dynamic dragfactor and stroke detection', () => {
  ...
  testDriveAverageHandleForce(rower, 98.31702855077187)
  testDrivePeakHandleForce(rower, 100.88247161705996)
  testRecoveryDuration(rower, 0)
  testRecoveryDragFactor(rower, 100)
  testInstantHandlePower(rower, 183.78340380406857)
  ...
  testDriveAverageHandleForce(rower, 149.93658299954873)
  testDrivePeakHandleForce(rower, 204.7158151931895)
  testRecoveryDuration(rower, 0)
  testRecoveryDragFactor(rower, 100)
  testInstantHandlePower(rower, 0)
  ...
  testDriveLength(rower, 0.29321531433504733)
  testDriveAverageHandleForce(rower, 136.2046869191463)
  testDrivePeakHandleForce(rower, 211.27750153523766)
  testRecoveryDuration(rower, 0.27244301)
  testRecoveryDragFactor(rower, 269.73125212721015)
  testInstantHandlePower(rower, 400.55469467842033)
  ...
  testDriveAverageHandleForce(rower, 195.67653866345196)
  testDrivePeakHandleForce(rower, 299.9191284719814)
  testRecoveryDuration(rower, 0.27244301)
  testRecoveryDragFactor(rower, 269.73125212721015)
  testInstantHandlePower(rower, 0)
  ...
  testCycleDuration(rower, 0.34894194100000037)
  testCycleLinearDistance(rower, 1.3510795696388476)
  testCycleLinearVelocity(rower, 4.402335830596008)
  testCyclePower(rower, 238.8952638081548)
  testDriveDuration(rower, 0.1094471500000001)
  testDriveLinearDistance(rower, 0.29496983799620907)
  testDriveLength(rower, 0.2094395102393196)
  testDriveAverageHandleForce(rower, 139.45437947907456)
  testDrivePeakHandleForce(rower, 220.15142625402527)
  testRecoveryDuration(rower, 0.23949479100000026)
  testRecoveryDragFactor(rower, 289.7018411337537)
  testInstantHandlePower(rower, 417.2202735458787)
  ...
  testTotalNumberOfStrokes(rower, 2)
  testTotalLinearDistanceSinceStart(rower, 3.9135073726821044)
  testCycleDuration(rower, 0.36058336800000035)
  testCycleLinearDistance(rower, 1.0323944329867305)
  testCycleLinearVelocity(rower, 4.49919284402254)
  testCyclePower(rower, 255.01272739349062)
