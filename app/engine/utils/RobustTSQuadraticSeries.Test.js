...
test('Quadratic TS Estimation should result in a changing coefficientA when the force fluctuates', () => {
  ...
  assert.ok(dataSeries.slope(9) === 6.350000000011524, `coefficientB (Velocity at 1.10 sec) should be 6.350000000011524 at 1.11 sec, is ${dataSeries.slope(9)}`) // From data generation, Coef B should be 6.35
