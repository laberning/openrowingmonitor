...
test('Quadratic TS Estimation should result in a changing coefficientA when the force fluctuates', () => {
  ...
  assert.ok(dataSeries.slope(9) === 6.300000000011751, `coefficientB (Velocity at 1.11 sec) should be 6.300000000011751 at 1.12 sec, is ${dataSeries.slope(dataSeries.length() - 1)}`) // From data generation, Coef B should be 6.325
