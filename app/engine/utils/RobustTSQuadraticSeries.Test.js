...
test('Quadratic TS Estimation should result in a changing coefficientA when the force fluctuates', () => {
  ...
  assert.ok(dataSeries.slope(10) === 6.325000000039106, `coefficientB should be 6.325000000039106, is ${dataSeries.slope(dataSeries.length() - 1)}`) // From data generation, Coef B should be 6.325
  ...
  assert.ok(dataSeries.slope(10) === 6.300000000011751, `coefficientB should be 6.300000000011751 at 1.12 sec, is ${dataSeries.slope(dataSeries.length() - 1)}`) // From data generation, Coef B should be 6.3
  ...
  assert.ok(dataSeries.slope(9) === 6.300000000011751, `coefficientB should be 6.300000000011751 at 1.12 sec for 1.11, is ${dataSeries.slope(dataSeries.length() - 1)}`) // From data generation, Coef B should be 6.325
