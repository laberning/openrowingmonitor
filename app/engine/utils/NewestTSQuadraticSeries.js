...
function createTSQuadraticSeries (maxSeriesLength = 0) {
  ...
  function calculateB (pointOne, pointThree) {
    ...
    if (pointOne < pointTwo && X.get(pointOne) !== X.get(pointTwo)) {
      ...
      return (- (X.get(pointTwo) * Y.get(pointOne))/((Math.pow(X.get(pointOne), 2) - X.get(pointOne) * X.get(pointTwo) - X.get(pointOne) * X.get(pointThree) + X.get(pointTwo) * X.get(pointThree)) - (X.get(pointThree) * Y.get(pointOne))/((Math.pow(X.get(pointOne), 2) - X.get(pointOne) * X.get(pointTwo) - X.get(pointOne) * X.get(pointThree) + X.get(pointTwo) * X.get(pointThree)) - (X.get(pointOne) * Y.get(pointTwo))/(- X.get(pointOne) * X.get(pointTwo) + X.get(pointOne) * X.get(pointThree) + Math.pow(X.get(pointTwo), 2) - X.get(pointTwo) * X.get(pointThree)) - (X.get(pointThree) * Y.get(pointTwo))/(- X.get(pointOne) * X.get(pointTwo) + X.get(pointOne) * X.get(pointThree) + Math.pow(X.get(pointTwo), 2) - X.get(pointTwo) * X.get(pointThree)) - (X.get(pointOne) * Y.get(pointThree))/(X.get(pointOne) * X.get(pointTwo) - X.get(pointOne) * X.get(pointThree) - X.get(pointTwo) * X.get(pointThree) + Math.pow(X.get(pointThree), 2)) - (X.get(pointTwo) * Y.get(pointThree))/(X.get(pointOne) * X.get(pointTwo) - X.get(pointOne) * X.get(pointThree) - X.get(pointTwo) * X.get(pointThree) + Math.pow(X.get(pointThree), 2))))
    } else {
