...
function createRowingEngine (rowerSettings) {
  ...
  let prevDt = rowerSettings.maximumImpulseLength
  let kPower = 0.0
  let jPower = 0.0
  ...
  function handleRotationImpulse (currentDt) {
    ...
    if (currentDt < rowerSettings.minimumImpulseLength || currentDt > rowerSettings.maximumImpulseLength || currentDt < (rowerSettings.maximumDownwardChange * prevDt) || currentDt > (rowerSettings.maximumUpwardChange * prevDt)) {
