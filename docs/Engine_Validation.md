...
* One approach is the adjustment of the Magic Factor from 2,8 to 2,76. However, as the relation P = 2.8 \* u<sup>3</sup> holds for each stroke in all investigated exported data from a rowing session, we consider this approach infeasible;
